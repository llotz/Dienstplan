...
class MysqliDb
{
    ...
    public function setCharset($charset){
        foreach($this->_mysqli as $mysqlConn){
                $mysqlConn->set_charset($charset);
        }
    }
    ...
    {
        $this->_mysqli["default"]->set_charset("utf8");
    ...
    protected function _buildQuery($numRows = null, $tableData = null)
    {
        ...
        // Prepare query
        $stmt = $this->_prepareQuery();
        //echo count($this->_bindParams);
        //print_r(array($stmt, 'bind_param'));
